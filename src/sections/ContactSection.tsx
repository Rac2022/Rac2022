    ...
    <section id="contact" className="relative py-28 md:py-40 px-4">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
          ...
          >
            {t.contact.cta} <ArrowUpRight className="w-4 h-4" />
          </a>
          <a
            href="mailto:rodolfoavalos635@gmail.com"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 max-w-3xl mx-auto">
          ...
          <GlassCard delay={0.24} className="text-center group">
            <a href="#" className="block">
              <Calendar className="w-4 h-4 text-white/30 mx-auto mb-2 group-hover:text-white/60 transition-colors" />
              <p className="font-body font-medium text-white text-xs mb-0.5">{t.contact.schedule}</p>
            </a>
          </GlassCard>
        </div>
      </div>
