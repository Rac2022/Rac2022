    ...
    <section className="relative py-28 md:py-40 px-4">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="max-w-2xl mx-auto font-body font-light text-white/40 text-sm leading-relaxed mb-16">
          Rodolfo works at the intersection of business development, territory strategy, compliance-driven sales systems, and AI-assisted workflows — while side projects and deep curiosity about science and technology keep the engine running.
        </p>
