...
export function SignalFilters() {
  ...
  const hasFilters = currentStatus || currentSourceType || currentMinScore || currentSearch;
    ...
    <div className="sticky top-14 z-30 -mx-4 bg-[var(--background)]/90 px-4 py-3 backdrop-blur-md sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
      <div className="flex flex-wrap items-end gap-3">
        <div className="flex-1 min-w-[200px]">
          <label className="mb-1.5 block text-[11px] font-medium uppercase tracking-wider text-[var(--muted)]">Search</label>
          <input
            type="text"
        ...
        <div>
          <label className="mb-1.5 block text-[11px] font-medium uppercase tracking-wider text-[var(--muted)]">Status</label>
          <select
            value={currentStatus}
        ...
        <div>
          <label className="mb-1.5 block text-[11px] font-medium uppercase tracking-wider text-[var(--muted)]">Source Type</label>
          <select
        ...
        <div>
          <label className="mb-1.5 block text-[11px] font-medium uppercase tracking-wider text-[var(--muted)]">Min Score</label>
          <input
            type="number"
            min={0}
            max={100}
